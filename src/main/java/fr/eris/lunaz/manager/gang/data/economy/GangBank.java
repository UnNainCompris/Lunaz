package fr.eris.lunaz.manager.gang.data.economy;

import com.google.gson.annotations.Expose;
import fr.eris.lunaz.LunaZ;
import fr.eris.lunaz.event.gang.currency.OnGangBankUpdateEvent;
...
public class GangBank {
    ...
    public Tuple<Long, Boolean> postChangeValueEvent(long newValue) {
        OnGangBankUpdateEvent event = new OnGangBankUpdateEvent(LunaZ.getGangManager().getGang(ownerID), value, newValue);
